...
public class ProcessorTest {
    ...
    public void ProcessQueryAndValidResult(String queryDir) throws IOException {
        ...
        // HashMap<String, List<Integer>> cohortData = mapper.readValue(new File(queryResultPath), HashMap.class);
        HashMap<String, List<Integer>> cohortData = mapper.readValue(new File(queryResultPath), new TypeReference<HashMap<String,List<Integer>>>(){});
        // check the result
