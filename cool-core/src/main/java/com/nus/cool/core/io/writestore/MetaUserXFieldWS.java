 ...
 * --------------------------------------------------
 */
public class MetaUserXFieldWS extends MetaHashFieldWS {

    private Map<Integer, List<Object>> userToInvariant = Maps.newTreeMap();
    private int invatiantSize;

    public MetaUserXFieldWS(FieldType type, Charset charset, OutputCompressor compressor, int invatiantSize) {
