...
public class MetaChunkWS implements Output {
     ...
     */
    public MetaChunkWS(int offset, MetaFieldWS[] metaFields, int userKeyIndex, List<Integer> invariantFieldIndex) {
     ...
     */
    public static MetaChunkWS newMetaChunkWS(TableSchema schema, int offset, int userKeyIndex, List<Integer> invariantFieldIndex) {
