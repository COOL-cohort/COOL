...
public class FastOutputStream extends OutputStream {
    ...
    /**
     * Creates a new bute array output stream. The buffer capacity in initially 32
     ...
     * write method using <code>out.write(buffer, 0, count)</code>.
     *
     ...
     *                          request for the unsatisfiable large capacity
     *                          {@code (long) Integer.MAX_VALUE + (minCapacity - Integers.MAX_VALUE)}
     */
