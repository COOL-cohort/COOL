...
public class FastInputStream extends InputStream {
     ...
     * can ever be read from the stream; element <code>buffer[pos]</code> is the next
     * byte to be read.
     */
     ...
     * length of <code>buffer</code>. It is one greater than the position of the last
     * byte within <code>buffer</code> that can ever be read from the input stream
     * buffer.
     */
    protected int count;

    /**
     * Creates a <code>ByteArrayInputStream</code> so that it uses <code>buffer</code>
    ...
    /**
     * Creates <code>ByteArrayInputStream</code> that uses <code>buffer</code> as its
