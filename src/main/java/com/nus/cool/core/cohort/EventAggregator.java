...
public interface EventAggregator {
    ...
    void ageAggregate(BitSet ageOffset, BitSet ageDelimiter, int ageOff, int ageEnd,
                      int ageInterval, FieldFilter ageFilter,
     ...
     * @param firstDay first day after born
     * @param ageMetrics
     */
    void ageAggregate(BitSet ageOffset, InputVector time, int birthDay,
                      int ageOff, int ageEnd,
